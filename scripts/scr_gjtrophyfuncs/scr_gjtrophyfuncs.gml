...
function gj_trophies_fetch_all(_username, _user_token)
{
	...
	{
		var unhashed = "https://api.gamejolt.com/api/game/v1_2/trophies/?game_id=" + string(global.gameid) + "&username=" + string(_username) + "&user_token=" + string(_user_token) + global.key
		var hashed = md5_string_utf8(unhashed);
	
		var response = http_get("https://api.gamejolt.com/api/game/v1_2/trophies/?game_id=" + string(global.gameid) + "&username=" + string(_username) + "&user_token=" + string(_user_token) + "&signature=" + string(hashed));
	}
}
...
function gj_trophies_fetch_specific(_username, _user_token, _trophy_id)
{
	if global.gj_isoccupied == false
	{
		var unhashed = "https://api.gamejolt.com/api/game/v1_2/trophies/?game_id=" + string(global.gameid) + "&username=" + string(_username) + "&user_token=" + string(_user_token) + "&trophy_id=" + string(_trophy_id) + global.key
		var hashed = md5_string_utf8(unhashed);
	
		var response = http_get("https://api.gamejolt.com/api/game/v1_2/trophies/?game_id=" + string(global.gameid) + "&username=" + string(_username) + "&user_token=" + string(_user_token) + "&trophy_id=" + string(_trophy_id) + "&signature=" + string(hashed));
	}
}
...
function gj_trophies_unlock(_username, _user_token, _trophy_id)
{
	if global.gj_isoccupied == false
	{
		var unhashed = "https://api.gamejolt.com/api/game/v1_2/trophies/add-achieved/?game_id=" + string(global.gameid) + "&username=" + string(_username) + "&user_token=" + string(_user_token) + "&trophy_id=" + string(_trophy_id) + global.key
		var hashed = md5_string_utf8(unhashed);
	
		var response = http_get("https://api.gamejolt.com/api/game/v1_2/trophies/add-achieved/?game_id=" + string(global.gameid) + "&username=" + string(_username) + "&user_token=" + string(_user_token) + "&trophy_id=" + string(_trophy_id) + "&signature=" + string(hashed));
	}
}
...
function gj_trophies_lock(_username, _user_token, _trophy_id)
{
	if global.gj_isoccupied == false
	{
		var unhashed = "https://api.gamejolt.com/api/game/v1_2/trophies/remove-achieved/?game_id=" + string(global.gameid) + "&username=" + string(_username) + "&user_token=" + string(_user_token) + "&trophy_id=" + string(_trophy_id) + global.key
		var hashed = md5_string_utf8(unhashed);
	
		var response = http_get("https://api.gamejolt.com/api/game/v1_2/trophies/remove-achieved/?game_id=" + string(global.gameid) + "&username=" + string(_username) + "&user_token=" + string(_user_token) + "&trophy_id=" + string(_trophy_id) + "&signature=" + string(hashed));
	}
}