...
#region ----- Keypair Data Format -----

if global.dataform = "keypair"
{
	if global.logbool
	{
		show_debug_message("----- The following text is the response from an external server. -----");
		...
		*/
		...
		show_debug_message("WARNING: THIS WAS NOT STORED IN THE RESPONSE VARIABLE, SINCE IT WAS NOT FORMATTED!")
